...
export default function TopHeader() {
  ...
  return (
    <header
      className={`fixed top-0 right-0 h-16 bg-slate-900 border-b border-slate-800 z-40 transition-all duration-300 flex items-center justify-end px-6 gap-4 ${
    ...
    >
      ...
      <div className="relative">
        <input
          type="text"
          placeholder="Search..."
          className="bg-slate-800 text-slate-300 text-sm px-4 py-2 pl-10 rounded-lg border border-slate-700 focus:outline-none focus:border-blue-500 w-64"
        />
