            ...
            <div className='space-y-3'>
              {
                ListItems.map((item) => {
                  return (
                    <div className={`${selectedItem === item.id ? "bg-green-800 text-white" : "dark:bg-[#18181b] bg-gray-300 text-gray-800"} rounded-lg p-2 text-gray-300 flex items-center gap-3 cursor-pointer`}
