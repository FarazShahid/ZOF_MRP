...
const ProductStats: React.FC<Props> = ({ products, statusFilter, onStatusChange, archivedFilter, onArchivedChange }) => {
  ...
  const cards = [
    ...
    { title: "No Status", value: emptyStatus, icon: HelpCircle, gradient: "from-yellow-600 to-yellow-700", border: "border-yellow-500/20", labelCls: "text-yellow-100", iconCls: "text-yellow-200", onClick: () => onStatusChange("" as unknown as ProductStatus), active: (statusFilter as string) === "" },
