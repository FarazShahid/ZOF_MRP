      ...
      <div className="overflow-x-auto">
        <table className="min-w-full divide-y divide-slate-200">
          ...
          <tbody className="divide-y divide-slate-200">
            {items.map((it) => (
              <tr key={it.Id} className="hover:bg-slate-50 dark:hover:bg-slate-700 transition-colors even:bg-green-50 dark:even:bg-slate-700">
                ...
                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{it.UnitOfMeasureName}</td>
