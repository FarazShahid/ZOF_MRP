              ...
              {loading ? (
                ...
                <div className="space-y-3">
                  <div className="grid grid-cols-2 gap-2">
                    <SizeDataView label="Product Sub Category" value={sizeMeasurementById?.ProductSubCategoryName || "-"} />
                    <SizeDataView label="Style Number" value={sizeMeasurementById?.StyleNumber || "-"} />
                  </div>
